...
```{r, include=FALSE, echo=FALSE,results='hide',warning=FALSE,eval=FALSE}
...
```{r LSFig, fig.cap='Comparing the overall log library size vs the log library size using the control genes', echo=FALSE,warning=FALSE}
...
<!-- , but not-run. A pre-saved output is loaded for demonstrations. -->
...
```{r,message=FALSE,eval=FALSE,include=FALSE,eval=FALSE}
